...
st.set_page_config(page_title="Big Budget Recommendations", page_icon=":moneybag:")
st.header("Rank the Importance of Each Factor :clipboard:")
...
if len(ranked_factors) != 4:
    ...
    st.subheader("Top 5 Countries by Customized Overall Score :earth_americas:")
